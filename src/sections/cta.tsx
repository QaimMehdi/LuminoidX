...
const settings = {
  ...
  description: 'Let\'s discuss how our AI automation and web development solutions can help you achieve your goals. Get in touch today for a free consultation.',
  CTA: {
    content: 'Get Started',
    href: '#contact'
  }
